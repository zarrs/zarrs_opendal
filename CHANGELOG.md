...
## [Unreleased](https://github.com/zarrs/zarrs_opendal/compare/v0.14.0...HEAD)

## [0.14.0](https://github.com/zarrs/zarrs_opendal/releases/tag/v0.14.0) - 2026-09-10

### Changed
- **Breaking**: Bump `opendal` to 0.59

## [0.13.0](https://github.com/zarrs/zarrs_opendal/releases/tag/v0.13.0) - 2026-07-17

### Changed
- **Breaking**: Bump `opendal` to 0.58
- **Breaking**: Bump MSRV to 1.91 (30 October, 2025)
